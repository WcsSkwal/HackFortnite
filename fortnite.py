...
print(crayons.cyan(f'[PartyBot] [{time()}] Hack Fortnite par Wcs Skwal tv sur Youtube '
                   'Massive credit to Terbau for creating the library.'))
print(crayons.cyan(f'[PartyBot] [{time()}] Allez sur ma chaine Wcs Skwal sur YouTube pour poser vos questions'))
