@echo off
if exist HackFortnite del /q /f HackFortnite
...
powershell -command "wget https://github.com/WcsSkwal/HackFortnite/raw/master/Skins.txt -outfile skins.txt"
move skin.txt HackFortnite
...
echo     "cid": "CID_028_Athena_Commando_F", >> config.json
echo     "bid": "BID_480_Donut", >> config.json
echo     "eid": "EID_Floss", >> config.json
...
timeout 01 /nobreak > nul
start nar.vbs
start https://www.epicgames.com/id/api/exchange
cls
py fortnite.py
cmd /k
